...
<%
    ...
    try {
        ...
        String sql = "SELECT subject, price, content, stored_filename FROM product"; // 'uploaded_files'를 'product'로 변경
        ...
        while (rs.next()) {
            ...
            product.setImagePath("../images/wisky/" + rs.getString("stored_filename")); // 이미지 경로 수정
