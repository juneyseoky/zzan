...
<%
    ...
    try {
        ...
        String sql = "SELECT subject, price, content, stored_filename FROM product where category = "; // 'uploaded_files'를 'product'로 변경
    			sql += pType; 
        ...
        while (rs.next()) {
            ...
            product.setImagePath("../images/whisky/" + rs.getString("stored_filename")); // 이미지 경로 수정
