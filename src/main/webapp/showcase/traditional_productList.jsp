...
<%
    ...
    try {
        ...
        String sql = "SELECT subject, price, content, stored_filename FROM uploaded_files WHERE category = 'traditional'"; // 전통주만 선택
        ...
        while (rs.next()) {
            ...
            product.setImagePath("../images/traditional/" + rs.getString("stored_filename")); // 이미지 경로 수정
